...
def MainLoop():
    ...
    if (integrity > 0.0 and integument > 0.0 and energy > 0.0):
        ...
        #hypo 0.1   normal 0.2   hyper 0.4

        r_pain  = correlation_factor * damage
        c_pain = min(1.0, c_pain * (0.8) + r_pain )
        #c_pain = (c_pain + r_pain)*0.5
        #c_pain = min(1.0, r_pain)
        c_pain = max(0.0, c_pain)
        #c_pain = 0
        print("pain = ", c_pain)
